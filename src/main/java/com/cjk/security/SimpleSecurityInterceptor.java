...
public class SimpleSecurityInterceptor extends AbstractSecurityInterceptor implements Filter {
	...
	public SimpleSecurityInterceptor(SimpleAccessDecisionManager accessDecisionManager,
			AuthenticationManager authenticationManager,
			SimpleFilterInvocationSecurityMetadataSource invocationSecurityMetadataSource) {
