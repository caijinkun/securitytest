...
CREATE TABLE IF NOT EXISTS `t_resource_info` (
  ...
  `node_type` tinyint(1) DEFAULT NULL COMMENT '1 根节点 2 中间节点 3 叶子节点',
...
INSERT INTO `t_resource_info` (`resource_id`, `resource_name`, `type`, `resource_order`, `url`, `parent_id`, `parent_ids`, `permision`, `node_type`, `icon`, `remark`) VALUES
	(1, '菜单', 1, 0, NULL, 0, NULL, '#', 1, NULL, '根节点'),
	(2, 'Admin', 1, 10000, '', 1, '', '/admin/**', NULL, '', NULL),
	(3, '用户管理', 1, 10000, '/admin/user', 2, '', '/admin/user/*', NULL, 'glyphicon glyphicon-asterisk', ''),
	(4, '角色管理', 1, 10000, '/admin/role', 2, '', '/admin/role/*', NULL, 'glyphicon glyphicon-asterisk', NULL),
	(5, '资源管理', 1, 10000, '/admin/resource', 2, '', '/admin/resource/*', NULL, 'glyphicon glyphicon-asterisk', NULL);
...
-- 正在导出表  security_test.t_role_resource_link 的数据：~6 rows (大约)
...
INSERT INTO `t_user_info` (`user_id`, `username`, `password`, `salt`, `locked`, `expire_at`, `status`) VALUES
	...
	(3, 'test', '$2a$10$Yaza2qADGTboN0lAkrrT9OlamSj7LTdU0h.NkRjz5dIVwqmuYrvD2', NULL, 0, 0, 0),
	(6, 'abc', '$2a$10$Yaza2qADGTboN0lAkrrT9OlamSj7LTdU0h.NkRjz5dIVwqmuYrvD2', NULL, 0, 0, 0),
	...
	(14, 'tttt', '$2a$10$Yaza2qADGTboN0lAkrrT9OlamSj7LTdU0h.NkRjz5dIVwqmuYrvD2', NULL, 1, 0, 0),
...
-- 正在导出表  security_test.t_user_role_link 的数据：~6 rows (大约)
